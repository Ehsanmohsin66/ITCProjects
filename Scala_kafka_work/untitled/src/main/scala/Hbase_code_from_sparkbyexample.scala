...
object HBaseSparkExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    df_test.write.options(Map(HBaseTableCatalog.tableCatalog -> catalog, HBaseTableCatalog.newTable -> "4")).format("org.apache.spark.sql.execution.datasources.hbase").save()
  }
}
